        ...
        <>
          <div className={classes.root}>
            ...
            <Typography variant='body2' className={classes.subText}>
              <HighlightOutlined className={classes.subIcon} />{' '}
              {(energy || 0) + ' OXY'}
            </Typography>
            <Typography variant='body2' className={classes.subText}>
              <CreditCardOutlined className={classes.subIcon} />{' '}
              {(balance || 0) / 100000000 + ' TRE'}
            </Typography>
            <Typography variant='body2' className={classes.subText}>
              <DateRangeOutlined className={classes.subIcon} />{' '}
              {moment(createdAt)
                .format('LLL')
                .toString()}
            </Typography>
          </div>
          <div className={classes.paymenHistory}>
            <PaymentHistory />
          </div>
        </>
      );
